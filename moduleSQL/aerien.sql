...
SELECT pilotes.nom, pilotes.prenom FROM vols INNER JOIN avions ON vols.id_avion = avions.id_avion INNER JOIN pilotes ON vols.id_pilote = pilotes.id_pilote WHERE fabricant = 'AIRBUS';